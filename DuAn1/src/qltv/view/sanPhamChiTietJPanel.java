...
public class sanPhamChiTietJPanel extends javax.swing.JPanel {
    ...
    Map<String, Integer> screenMap = new HashMap<>();
    ...
    void setComboBox() {
        ...
        for (thuongHieu th : spServiceImpl.getTenThuongHieu()) {
            ...
            brandMap.put(th.getTen(), th.getId());
        }
    ...
    void showData(int i) {
        ...
        if (tbl_bang.getValueAt(i, 11).toString().equalsIgnoreCase("Còn Hàng")) {
...
//            int id = Integer.parseInt(txt_idSp.getText().trim());
//            if (spServiceImpl.checkMaSpct(ma) == false) {
//                if (spServiceImpl.checkIdSp(id) == false) {
//                    jlb_thongBao.setText("ID Sản Phẩm chưa tồn tại !");
//                } else {
