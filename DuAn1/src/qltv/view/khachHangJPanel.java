...
public class khachHangJPanel extends javax.swing.JPanel {
    ...
    private void btnThemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnThemActionPerformed
        try {
            if (checkMa(khServiceImpl.getAll()) == true) {
                JOptionPane.showMessageDialog(this, "Bạn đã nhập trùng mã");
            } else {
                if (txt_Ma.getText().trim().equals("")) {
                    JOptionPane.showMessageDialog(this, "Mã không được để trống");
                } else if (txt_Ten.getText().trim().equals("")) {
                    JOptionPane.showMessageDialog(this, "Tên không được để trống");
                } else if (khServiceImpl.them(this.readForm()) > 0) {
                    fillToTable(khServiceImpl.getAll());
    ...
    private void btnSuaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSuaActionPerformed
        ...
        if (tbl_KhachHang.getSelectedRow() == -1) {
            ...
            JOptionPane.showMessageDialog(this, "Tên không được để trống");
        } else if (khServiceImpl.sua(this.readForm()) > 0) {
            fillToTable(khServiceImpl.getAll());
