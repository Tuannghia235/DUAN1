...
public class hoaDonKhachJFrame1 extends javax.swing.JFrame {

    static hoaDonJPanel setCustomerInfo;
    HoaDonService HoaDonRespository;
    DefaultTableModel dtmHoaDon;

    public hoaDonKhachJFrame1(hoaDonJPanel parentPanel) {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(hoaDonKhachJFrame1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new hoaDonKhachJFrame1(setCustomerInfo).setVisible(true);
            }
        });
    }
